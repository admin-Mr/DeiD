...
@Embeddable
public class DSID04_1Pk implements Serializable {
    private java.lang.String MODEL_NA;	//型體
    private java.lang.String EL_SEQ;	//項次
    public DSID04_1Pk() {
        super();
    }
    public DSID04_1Pk(java.lang.String MODEL_NA, java.lang.String EL_SEQ) {
        super();
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof DSID04_1Pk))
            return false;
        DSID04_1Pk castOther = (DSID04_1Pk) other;
