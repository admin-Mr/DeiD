...
public class DSID11_1Pk implements Serializable {
	...
	public DSID11_1Pk(java.lang.String MODEL_NA, java.lang.String EL_SEQ) {
	        super();
	...
	public boolean equals(final Object other) {
		if (!(other instanceof DSID11_1Pk))
			return false;
		DSID11_1Pk castOther = (DSID11_1Pk) other;
