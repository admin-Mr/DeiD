...
public class ReadIDPic06 extends QueryWindow{
	...
	public void setCustomData() throws IOException{
		...
		userid = "FORMING_DATE";
		State = userid;
		System.out.println(" ----- 06 State: " + State);
	...
	protected String getSQLWhere() {
		...
		str = " where "+Querys+" < trunc(sysdate) AND "+State+" IS NULL AND IS_DEL ='N' ";
		return str;
	}
	...
	protected String getCustomSQL() {
		// TODO Auto-generated method stub
		return "SELECT substr(WORK_ORDER_ID, 14, 19) WORK_ORDER_ID,PG_DATE,MODEL_NA,DECIDE_DATE,SEWING_DATE,FORMING_DATE,"
				+ "BOTTOM_TIME,REPAIR_TYPE,SCAN_DATE,FORMING_OK_DATE "
				+ "FROM DSID65 ";
	}
