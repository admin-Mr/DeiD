...
public class DSIDN06_01M_Query extends QueryWindow {
...
//		}
	...
	protected String getCustomSQL() {
		return " select t.MT_CODE,t.MT_PONO,t.MT_SEQ,t.EL_NO,t.MODEL_NA "+
			   "from DSID76 t   ";
	}
	...
	protected String getOrderby() {
		return " Order by to_number(t.MT_SEQ)  ";
	}
	...
	protected List getCustList() {
		...
		// MT_CODE,MT_PONO,MT_SEQ,EL_NO,MODEL_NA
		if (qry != null) {
			for (Iterator i = qry.getResultList().iterator(); i.hasNext();) {
				Object[] obj = (Object[]) i.next();
				DSID05 e = new DSID05();
				e.setMT_CODE((String) obj[0]);
				e.setMT_PONO((String) obj[1]);
				e.setMT_SEQ((String) obj[2]);
				e.setEL_NO(((String) obj[3]));
				e.setMODEL_NA((String) obj[4]);
				lst.add(e);
			}
		}
		return lst;
