...
public class DSID01MProgram extends Master{
...
//		masterComponentColumns.add(new ComponentColumn<Date>(txtorder_date, "ORDER_DATE", null, null, null));
	...
	public void onClickbtnArrange(Event event) throws Exception{
		...
		Executions.createComponents("/ds/dsid/DSID01MArrange.zul", null, map);
	}
	...
	public void onClickbtnTransfer(Event event) throws Exception{
		final HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("parentWindow", windowMaster);
		map.put("DSID01MProgram", this);
		Executions.createComponents("/ds/dsid/DSID01MTransfer.zul", null, map);
	}
	...
	protected ArrayList<String> getMasterKeyValue(Object entityMaster) {
		// TODO Auto-generated method stub
		DSID01 entity = (DSID01) entityMaster;
