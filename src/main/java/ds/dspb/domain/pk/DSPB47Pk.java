...
@Embeddable
public class DSPB47Pk implements Serializable {
	private static final long serialVersionUID = 1L;
	
	private java.lang.String PB_GROUPID;	//使用者代號
    private java.lang.String PB_USERID;	//使用者代號
    public DSPB47Pk() {
        super();
    }
    public DSPB47Pk(java.lang.String PB_GROUPID, java.lang.String PB_USERID) {
        super();
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof DSPB47Pk))
            return false;
        DSPB47Pk castOther = (DSPB47Pk) other;
