...
.mylist
        ...
        .z-listitem-over-seld {
	background-image: none;
	background-color: transparent;
}

/* Odd rows in a listbox */
.mylist .odd .mylist .gc, .mylist
        .odd, .mylist .z-listbox-odd, .mylist .z-grid-odd .mylist
        .z-row-inner, .mylist .z-grid-odd {
...
.mylist .z-listfooter-cnt, .mylist
        .z-listcell-cnt, .mylist .z-listheader-cnt {
	font-size: 11px;
	font-family: "Tahoma", verdana, arial, sans-serif;
	height: 13px;
}
...
.z-combobox-disabled *, .z-bandbox-disabled *, .z-datebox-disabled *, .z-timebox-disabled *, .z-spinner-disabled *, .z-doublespinner-disabled *,.z-timebox-disabled * {
...
/* -- 點擊按鈕顯示藍框 -- */
.z-textbox:focus,.z-intbox:focus,.z-decimalbox:focus,
.z-doublebox:focus,.z-intbox:focus,.z-longbox:focus,
.z-timebox:focus,.z-combobox-input:focus,.z-datebox-input:focus,
.z-bandbox-input:focus,.z-timebox-input:focus,.z-combobox-popup,
.z-datebox-popup,.z-bandbox-popup,.z-timebox-popup,.z-colorbox-popup{
	border: 1px solid #66afe9;
}

/* -- 越南語系 -- */
.z-textbox,.z-listcell-content,.z-combobox,.z-listheader-content, 
.z-listgroup-content, .z-listgroupfoot-content, .z-listfooter-content,z-combobox-input,.z-a, .z-button, .z-label, .z-menu-text, .z-menuitem-text, .z-nav-text, .z-navitem-text { 
 	font-family:"VNI-Times", "Open Sans"; 
}
